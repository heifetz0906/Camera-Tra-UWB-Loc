...
*********************************************/
/*       Gets Version       */
OKAO_API INT32 OKAO_FR_GetVersion(UINT8 *pbyMajor, UINT8 *pbyMinor);
...
OKAO_API HFEATURE OKAO_FR_CreateFeatureHandle( void );
...
OKAO_API INT32 OKAO_FR_ExtractFeature(HFEATURE hFeature, RAWIMAGE *pImage, INT32 nWidth, INT32 nHeight,
...
OKAO_API INT32 OKAO_FR_ExtractFeatureFromPtHdl(HFEATURE hFeature, RAWIMAGE *pImage, INT32 nWidth, INT32 nHeight, HPTRESULT hPtResult);
...
OKAO_API HALBUM OKAO_FR_CreateAlbumHandle(INT32 nMaxUserNum, INT32 nMaxDataNumPerUser);
...
/*      Restores Album Data                     */
OKAO_API HALBUM OKAO_FR_RestoreAlbum(UINT8 *pbyBuffer, UINT32 unBufSize, FR_ERROR *pError);
