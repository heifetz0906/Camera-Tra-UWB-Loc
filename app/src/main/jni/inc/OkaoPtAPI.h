...
OKAO_API HPOINTER   OKAO_PT_CreateHandle(void);
...
OKAO_API HPTRESULT  OKAO_PT_CreateResultHandle(void);
...
OKAO_API INT32      OKAO_PT_DetectPoint(HPOINTER hPT, RAWIMAGE *pImage, INT32 nWidth, INT32 nHeight, HPTRESULT hPtResult);
